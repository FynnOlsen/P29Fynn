...
box8=new Box(500,625,30,40);
box10=new Box(470,625,30,40);
box11=new Box(440,625,30,40);
box12=new Box(410,625,30,40);
box13=new Box(530,625,30,40);
box14=new Box(560,625,30,40);
box15=new Box(590,625,30,40);
